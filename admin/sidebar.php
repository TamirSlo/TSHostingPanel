<div id="sidebar-container" class="sidebar-expanded d-none d-md-block sidebarc">
    ...
    <ul class="list-group">
        ...
        <a href="#backups" class="bg-dark list-group-item list-group-item-action flex-column align-items-start text-muted">
            <div class="d-flex w-100 justify-content-start align-items-center">
        ...
        <div id='backups' class="collapse sidebar-submenu">
            <a href="/admin/backups" class="list-group-item list-group-item-action bg-dark text-white MenuABackupsBtn text-muted">
                <span class="menu-collapsed">All Backups</span>
            </a>
            <a href="/admin/backups/system" class="list-group-item list-group-item-action bg-dark text-white MenuABackupsSysBtn text-muted">
                <span class="menu-collapsed">System Backups</span>
            </a>
            <a href="/admin/backups/settings" class="list-group-item list-group-item-action bg-dark text-white MenuABackupsSettingsBtn text-muted">
